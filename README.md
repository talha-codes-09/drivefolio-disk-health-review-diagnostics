...
<div align="center">
  <img src="./public/logo.svg" alt="DriveFolio — Storage device health — Diagnostics" width="64" height="64">
  <h1>DriveFolio — Storage device health — Diagnostics</h1>
</div>

An independent project specification for Storage device health, covering health report import, device identity register, backup priority notes.
...
<img src="./public/screenshots/desktop-main.svg" alt="Storage device health — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Storage device health — compact concept, not a screenshot" width="250">
<br>
...
- **Health report import** — planned module; not implemented.
- **Device identity register** — planned module; not implemented.
- **Backup priority notes** — planned module; not implemented.

The proposed workflow separates health report import from device identity register, with backup priority notes retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Health report import**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="DriveFolio — Storage device health — Diagnostics — specification review workflow">
<br>
...
### Health report import

Define the input and expected outcome for module 1. Record the Storage device health version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Device identity register

Define the input and expected outcome for module 2. Record the Storage device health version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Backup priority notes

Define the input and expected outcome for module 3. Record the Storage device health version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | Storage device health |
| Category | PC utility specification |
| Input | Manual notes or user-authorized local exports |
| Planned output | Health report import |
